...
const providerConnectionErrorPattern =
  /upstream connect error|disconnect\/reset before headers|remote connection failure|transport failure|delayed connect error|connection refused|websocket|socket hang up|econnreset|econnrefused/i;
