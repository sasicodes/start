...
export const attachedPanelHiddenMotion = { scaleX: 0.995, scaleY: 0.96 } as const;
...
export const attachedPanelTransition = {
  scaleX: { type: 'spring', duration: 0.14, bounce: 0.16 },
  scaleY: { type: 'spring', duration: 0.14, bounce: 0.2 }
