  ...
  return (
    <div data-streamdown="table-wrapper" class={tw('group/table relative max-w-full', className)}>
      ...
      {edges.left && (
        <div
          aria-hidden="true"
          class="pointer-events-none absolute inset-y-0 left-0 w-8 rounded-l-[inherit] bg-gradient-to-r from-ink/8 to-transparent"
        />
      )}
      {edges.right && (
        <div
          aria-hidden="true"
          class="pointer-events-none absolute inset-y-0 right-0 w-8 rounded-r-[inherit] bg-gradient-to-l from-ink/8 to-transparent"
        />
      )}
