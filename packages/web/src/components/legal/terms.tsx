    ...
    <div className="relative min-h-dvh w-full bg-retro-cream font-sans">
      <div style={{ maxWidth: `${INNER_RAIL}px` }} className="mx-auto px-6 pt-12 pb-0 sm:px-10 sm:pt-20">
        <Header
          title="Terms"
          updated="May 24, 2026"
          subtitle="These terms govern your use of Start, your coding assistant for macOS."
        />
        <div className="mt-12 flex flex-col gap-10 pb-20 sm:mt-16">
          ...
          <Section title="Your keys, your usage">
            <p>
              Start operates with the API keys and access tokens you configure on your machine. You own them, and you
              are responsible for any usage or costs incurred with the providers you choose.
            </p>
            <p>
              <strong className="font-semibold text-zinc-900">Keys are stored securely in the macOS Keychain.</strong>{' '}
              We do not see them and we do not manage them.
            </p>
          </Section>
          ...
          <Section title="Third-party services">
            <p>
              ...
              by their terms. Start acts as a local client, and any limits, fees, or rate caps apply to your
              relationship with those services directly.
            </p>
          </Section>
