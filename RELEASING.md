...
Examples below use `v0.1.0-beta.1`. Substitute the actual release tag.

## 1. Preview the bump

```sh
node scripts/release-desktop.js v0.1.0-beta.1 --dry-run
```
...
git checkout -b chore/bump-beta-1
node scripts/release-desktop.js v0.1.0-beta.1
git push -u origin chore/bump-beta-1
gh pr create --title "chore: bump desktop version to 0.1.0-beta.1"
```
...
- `patch` — `0.1.0-beta.1` → `0.1.1`
- `minor` — `0.1.0-beta.1` → `0.2.0`
- `major` — `0.1.0-beta.1` → `1.0.0`
